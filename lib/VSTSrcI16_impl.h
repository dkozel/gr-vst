...
#ifndef INCLUDED_VST_VSTSRCI16_IMPL_H
#define INCLUDED_VST_VSTSRCI16_IMPL_H
...
namespace gr {
  namespace VST {
    ...
    class VSTSrcI16_impl : public VSTSrcI16
    {
     private:
         void configure(void);

     public:
      VSTSrcI16_impl(char* resname,
          double iqrate,
          double carrierFreq,
          double reflevel);
      ~VSTSrcI16_impl();
...
#endif /* INCLUDED_VST_VSTSRCI16_IMPL_H */
